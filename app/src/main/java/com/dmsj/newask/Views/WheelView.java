...
import com.dmsj.newask.adapter.WheelAdapter;
...
//					MResource.getIdByName(getContext().getApplicationContext(), "drawable", "wheel_val"));
            centerDrawable = getContext().getResources().getDrawable(
...
//					RingMediaPlayerUtil.RING_WHEEL);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (itemsLayout == null) {
            if (itemsWidth == 0) {
                calculateLayoutWidth(getWidth(), MeasureSpec.AT_MOST);
            } else {
                createLayouts(itemsWidth, labelWidth);
            }
        }
