...
//        httpClient.setHttpRequestRetryHandler(new DefaultHttpRequestRetryHandler(DEFAULT_MAX_RETRIES,false));
...
//    	addHeader("system_version",HTalkApplication.getAppVersionName());
   ...
   /**
    ...
    public void get(Context context, String url, RequestParams params, AsyncHttpResponseHandler responseHandler) {
        MKLog.e("fxc", url + "?" + params.toString());
    ...
    public static String getUrlWithQueryString(String url, RequestParams params) {
        if(params != null) {
            params.put("appID",HttpRestClient.mDeviceId);
