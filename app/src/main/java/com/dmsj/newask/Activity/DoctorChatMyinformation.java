...
import com.dmsj.newask.Views.DoubleBtnFragmentDialog;
...
public class DoctorChatMyinformation extends FragmentActivity implements
...
//                        childAt.setChecked(true);
    ...
    public void onClick(View v) {
        ...
        if (v.getId()==R.id.title_back){
            finish();
        }else  if (v.getId()==R.id.button_age){
            showPop(1);
        }else  if (v.getId()==R.id.button_number){
            showPop(2);
