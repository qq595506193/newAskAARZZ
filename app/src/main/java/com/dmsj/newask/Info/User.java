...
public class User implements Serializable {
    ...
    public static User parseFormat(JSONObject json) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(HStringUtil.stringFormat(json.optString("robot")))) {

                JSONObject robot = new JSONObject((HStringUtil.stringFormat(json.optString("robot"))));
                user.nick_name = HStringUtil.stringFormat(robot.optString("CUSTOMER_NAME"));
                user.wake_command = HStringUtil.stringFormat(robot.optString("WAKE_COMMAND"));
//                RgineUtil.setRobotWake(user.wake_command);
                user.first_aid_Command = HStringUtil.stringFormat(robot.optString("FIRST_AID_COMMAND"));
            }
        } catch (Exception e) {
            return null;
        }
